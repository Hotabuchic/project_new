...
combination = ["qwertyuiop"[i:i + 3] for i in range(len("qwertyuiop") - 2)] + \
              ...
              ["йцукенгшщзхъ"[i:i + 3] for i in range(len("йцукенгшщзхъ") - 2)] + \
              ["фывапролджэ"[i:i + 3] for i in range(len("фывапролджэ") - 2)] + \
              ["ячсмитьбю"[i:i + 3] for i in range(len("ячсмитьбю") - 2)] + ["жэё"]
